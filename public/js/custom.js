...
(function ($) {
  ...
  $(document).ready(function($) {
    $(document).on('click', '#pills-tab button', function(e) {
      e.preventDefault();
      $(this).tab('show');
    });
...
$('#pills-tab button[data-bs-target="' + hash + '"]').tab('show');
...
$(document).ready(function(){
  $("#toggle_btn").click(function(){
    ...
    $(".profileSection").toggleClass("toggle");
  });
});
...
//   $('.statisticsModal').css('display','block');
//   $('.statisticsModal').addClass('show');

$(document).ready(function() {
  $(document).click(function(event) {
    if ($(event.target).closest('.notificationbox').length === 0) {
      $('.notificationbox').removeClass('showbox');
    }
  });
  $('#onbellclick').click(function(event) {
    event.stopPropagation();
    $('.notificationbox').toggleClass('showbox');
  });
});
